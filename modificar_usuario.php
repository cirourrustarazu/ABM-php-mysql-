...
<html lang="en">
  ...
  <body class="container-fluid">
    ...
    <div class="alert alert-dark text-center fst-italic" role="alert">
        <h3>Modificacion de usuario existente en la BDD</h3>
    </div>
     <!-- FORMULARIO -->
     <div class="row">
      <div class="col-4"></div>
      ...
      <form action="modificar_usuario_sql.php" method="POST">
          <div class="mb-3">
            <label for="usuario" class="form-label">Usuario: </label>
            <input type="text" class="form-control" disabled id="usuario" name="usuario" value=<?php echo $usuario; ?> >
           </div>
          <div class="mb-3">
          ...
          <div class="d-grid gap-2">
            ...
            <button type="submit" class="btn btn-danger form-control" name="boton" value=1>Modificar</button>
